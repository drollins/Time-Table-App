...
(function ($) {
    ...
    function init(plot)
    {
        ...
        {        
            ...
            var srcArray = plot.getOptions().valueLabels.srcArray;
            ...
            $.each(plot.getData(), function(ii, series)
            {
                ...
                for (var i = 0; i < series.data.length; ++i)
                {
                    ...
                    var val = y;
                    //var val = srcArray[1][i][ii];
                    var val2;
                    if ( ii % 2 == 0 )
                    {
                        val2 = ""+srcArray[ii+1][i];
                    }
                    else
                    {
                        val2 = "";
